...
export const coluna_status_produto_bebida = CriaColunaTabela({
  name: 'situacao_produto_bebida',
  type: 'varchar',
  isNullable: false,
  length: '255'
});
...
export const coluna_produtoId = CriaColunaTabela({
  name: 'produtoId',
  type: 'integer',
  unsigned: true,
});
...
export const coluna_itemPedidoId = CriaColunaTabela({
  name: 'itemPedidoId',
  type: 'integer',
  unsigned: true,
});
